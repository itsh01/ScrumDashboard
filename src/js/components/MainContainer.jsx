...
define(['lodash', 'React', 'components/backlog/Backlog', 'components/sprint/Table', 'components/team/TeamComponent', '../stores/flux'], function (_, React, Backlog, SprintTable, TeamView, Flux) {
    'use strict';
